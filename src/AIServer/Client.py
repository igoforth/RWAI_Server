...
from .__init__ import LLAMAFILE_MODEL, logger
...
from .templates import story_t  # type: ignore
...
""".strip()
    ...
    async def do_chat(self, content: str, grammar: str | None = None):
        message: UserMessage = UserMessage(role=UserMessageRole.USER, content=content)
